        ...
        <table>
            ...
            <tbody>
                ...
                foreach ($estudiantes as $estudiante) {
                    ...
                    echo '  <td>';
                    echo '      <a href="views/Acciones_stu/form_estudiante.php?codigo=' . $estudiante->getCodigo() . '">MODIFICAR</a>';
                    echo '      <a href="views/Acciones_stu/accion_borrar_stu.php?codigo=' . $estudiante->getCodigo() . '">BORRAR</a>';
